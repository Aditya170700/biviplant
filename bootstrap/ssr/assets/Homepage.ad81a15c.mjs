    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Head), null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<title${_scopeId}>${ssrInterpolate(props.meta_title)}</title><meta head-key="description" name="description"${ssrRenderAttr("content", props.meta_description)}${_scopeId}><meta head-key="keyword" name="keyword"${ssrRenderAttr("content", props.meta_keyword)}${_scopeId}>`);
          } else {
            return [
              createVNode("title", null, toDisplayString(props.meta_title), 1),
              createVNode("meta", {
      ...
      ssrRenderList(__props.origins, (origin, i) => {
        _push(`<div class="row mb-2"><div class="col-lg-12"><div class="d-flex align-items-center"><div class="img"><img src="assets/images/logo/map-point.png" class="opacity-75" width="60" alt=""></div><div class="tex-left"><p class="mb-2">${ssrInterpolate(origin.subdistrict.city.province.name)}</p><p>${ssrInterpolate(origin.detail)}</p></div></div></div></div>`);
      });
