  ...
  _push(ssrRenderComponent(_component_Layout, mergeProps({
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(`</span></th><th${_scopeId}><span class="d-flex justify-content-between" style="${ssrRenderStyle({ "cursor": "pointer" })}"${_scopeId}> META TITLE `);
        if ($setup.params.direction == "asc" && $setup.params.field == "meta_title") {
          _push2(`<i class="fa-solid fa-arrow-down-a-z"${_scopeId}></i>`);
        } else {
          _push2(`<!---->`);
        }
        if ($setup.params.direction == "desc" && $setup.params.field == "meta_title") {
          _push2(`<i class="fa-solid fa-arrow-up-z-a"${_scopeId}></i>`);
        } else {
          _push2(`<!---->`);
        }
        ...
        ssrRenderList($props.results.data, (result, i) => {
          _push2(`<tr${_scopeId}><td${_scopeId}>${ssrInterpolate(i + 1)}</td><td${_scopeId}>${ssrInterpolate(result.name)}</td><td${_scopeId}>${ssrInterpolate(result.meta_title)}</td><td class="d-flex justify-content-end"${_scopeId}>`);
                    ...
                    createVNode("table", { class: "table" }, [
                      createVNode("thead", { class: "table-dark" }, [
                        createVNode("tr", null, [
                          ...
                          createVNode("th", null, [
                            createVNode("span", {
                              onClick: ($event) => $setup.sort("meta_title"),
                              class: "d-flex justify-content-between",
                              style: { "cursor": "pointer" }
                            }, [
                              createTextVNode(" META TITLE "),
                              $setup.params.direction == "asc" && $setup.params.field == "meta_title" ? (openBlock(), createBlock("i", {
                                key: 0,
                                class: "fa-solid fa-arrow-down-a-z"
                              })) : createCommentVNode("", true),
                              $setup.params.direction == "desc" && $setup.params.field == "meta_title" ? (openBlock(), createBlock("i", {
                                key: 1,
                                class: "fa-solid fa-arrow-up-z-a"
                              })) : createCommentVNode("", true)
                            ], 8, ["onClick"])
                      ...
                      createVNode("tbody", null, [
                        (openBlock(true), createBlock(Fragment, null, renderList($props.results.data, (result, i) => {
                          return openBlock(), createBlock("tr", { key: i }, [
                            ...
                            createVNode("td", null, toDisplayString(result.meta_title), 1),
