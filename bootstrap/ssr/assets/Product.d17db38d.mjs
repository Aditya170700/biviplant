...
import { _ as _sfc_main$5 } from "./Footer.8d824544.mjs";
import _sfc_main$2 from "./AddressModal.4058c900.mjs";
import _sfc_main$4 from "./CourierModal.f8702782.mjs";
...
import _sfc_main$3 from "./AddressModalGuest.3e91e423.mjs";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div><div class="sales-offer-content mb-2"><hr class="my-2"><ul class="mb-2"><li><i class="lni lni-checkmark-circle"></i> 100% Kualitas Unggul </li><li><i class="lni lni-checkmark-circle"></i> Bergaransi </li><li><i class="lni lni-checkmark-circle"></i> 100% Terpercaya </li></ul></div><div class="sales-offer-content mb-2"><hr class="my-2"><h6 class="mb-2">Deskripsi</h6><p>${__props.product.description}</p></div><div class="sales-offer-content my-5"><div class="d-flex justify-content-between align-items-center"><h6>Produk Terkait</h6>`);
      _push(ssrRenderComponent(unref(Link), {
        class: "btn btn-light",
        href: _ctx.route("category.show", { slug: (_e2 = (_d2 = __props.product) == null ? void 0 : _d2.category) == null ? void 0 : _e2.slug })
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` Lihat Semua `);
      ...
      _push(`</div><div class="related-product-slide carousel">`);
                        ...
                        if (_push4) {
                          ...
                          return [
                            createVNode("img", {
                              ...
                              alt: (_d3 = relatedProduct.files[0]) == null ? void 0 : _d3.alt
                            }, null, 8, ["src", "alt"])
                          ];
                        }
                      }),
