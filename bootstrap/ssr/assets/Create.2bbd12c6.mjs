  ...
  _push(ssrRenderComponent(_component_Layout, mergeProps({
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        if ($setup.form.errors.limit) {
          _push2(ssrRenderComponent(_component_FormText, {
            id: "limit",
            message: $setup.form.errors.limit
          }, null, _parent2, _scopeId));
        } else {
          _push2(`<!---->`);
        }
        ...
        if ($setup.form.errors.expired_at) {
          _push2(ssrRenderComponent(_component_FormText, {
            id: "expired_at",
            message: $setup.form.errors.expired_at
          }, null, _parent2, _scopeId));
        } else {
          _push2(`<!---->`);
        }
        ...
        if ($setup.form.errors.min_order) {
          _push2(ssrRenderComponent(_component_FormText, {
            id: "min_order",
            message: $setup.form.errors.min_order
          }, null, _parent2, _scopeId));
        } else {
          _push2(`<!---->`);
        }
        ...
        if ($setup.form.errors.discount) {
          _push2(ssrRenderComponent(_component_FormText, {
            id: "discount",
            message: $setup.form.errors.discount
          }, null, _parent2, _scopeId));
        } else {
          _push2(`<!---->`);
        }
        ...
        if ($setup.form.errors.max_discount) {
          _push2(ssrRenderComponent(_component_FormText, {
            id: "max_discount",
            message: $setup.form.errors.max_discount
          }, null, _parent2, _scopeId));
        } else {
          _push2(`<!---->`);
        }
                    ...
                    createVNode("div", { class: "row" }, [
                      createVNode("div", { class: "col-lg-6 mb-3" }, [
                        createVNode("div", { class: "mb-3" }, [
                          ...
                          $setup.form.errors.code ? (openBlock(), createBlock(_component_FormText, {
                            key: 0,
                            id: "code",
                            message: $setup.form.errors.code
                      ...
                      createVNode("div", { class: "col-lg-6 mb-3" }, [
                        createVNode("div", { class: "mb-3" }, [
                          ...
                          $setup.form.errors.desc ? (openBlock(), createBlock(_component_FormText, {
                            key: 0,
                            id: "desc",
                            message: $setup.form.errors.desc
                          }, null, 8, ["message"])) : createCommentVNode("", true)
                      ...
                      createVNode("div", { class: "col-lg-6 mb-3" }, [
                        createVNode("div", { class: "mb-3" }, [
                          ...
                          $setup.form.errors.limit ? (openBlock(), createBlock(_component_FormText, {
                            key: 0,
                            id: "limit",
                            message: $setup.form.errors.limit
                          }, null, 8, ["message"])) : createCommentVNode("", true)
                      ...
                      createVNode("div", { class: "col-lg-6 mb-3" }, [
                        createVNode("div", { class: "mb-3" }, [
                          ...
                          $setup.form.errors.expired_at ? (openBlock(), createBlock(_component_FormText, {
                            key: 0,
                            id: "expired_at",
                            message: $setup.form.errors.expired_at
                          }, null, 8, ["message"])) : createCommentVNode("", true)
                      ...
                      createVNode("div", { class: "col-lg-6 mb-3" }, [
                        createVNode("div", { class: "mb-3" }, [
                          ...
                          $setup.form.errors.min_order ? (openBlock(), createBlock(_component_FormText, {
                            key: 0,
                            id: "min_order",
                            message: $setup.form.errors.min_order
                          }, null, 8, ["message"])) : createCommentVNode("", true)
                      ...
                      createVNode("div", { class: "col-lg-6 mb-3" }, [
                        createVNode("div", { class: "mb-3" }, [
                          ...
                          $setup.form.errors.discount ? (openBlock(), createBlock(_component_FormText, {
                            key: 0,
                            id: "discount",
                            message: $setup.form.errors.discount
                          }, null, 8, ["message"])) : createCommentVNode("", true)
                      ...
                      createVNode("div", { class: "col-lg-6 mb-3" }, [
                        createVNode("div", { class: "mb-3" }, [
                          ...
                          $setup.form.errors.max_discount ? (openBlock(), createBlock(_component_FormText, {
                            key: 0,
                            id: "max_discount",
                            message: $setup.form.errors.max_discount
                          }, null, 8, ["message"])) : createCommentVNode("", true)
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Dashboard/Voucher/Create.vue");
