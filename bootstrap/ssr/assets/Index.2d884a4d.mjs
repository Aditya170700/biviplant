...
import { reactive, onMounted, resolveComponent, mergeProps, withCtx, createVNode, openBlock, createBlock, Fragment, renderList, toDisplayString, createCommentVNode, createTextVNode, withModifiers, withDirectives, vModelText, vModelSelect, useSSRContext } from "vue";
import axios from "axios";
import { LMap, LIcon, LTileLayer, LMarker, LControl, LControlLayers, LTooltip, LPopup, LPolyline, LPolygon, LRectangle } from "@vue-leaflet/vue-leaflet";
/* empty css                   */import { OpenStreetMapProvider } from "leaflet-geosearch";
import { ssrRenderComponent, ssrRenderStyle, ssrRenderList, ssrInterpolate, ssrRenderAttr, ssrIncludeBooleanAttr } from "vue/server-renderer";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  const _component_l_control = resolveComponent("l-control");
  const _component_l_marker = resolveComponent("l-marker");
  const _component_l_tooltip = resolveComponent("l-tooltip");
  ...
  _push(ssrRenderComponent(_component_Layout, mergeProps({ title: "Suplier" }, _attrs), {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="row"${_scopeId}><div class="col-md-12 grid-margin"${_scopeId}><div class="card"${_scopeId}><div class="card-body"${_scopeId}><form${_scopeId}><div class="row"${_scopeId}><div class="col-1g-12 mb-3"${_scopeId}><div style="${ssrRenderStyle({ "height": "75vh", "width": "100%", "z-index": "1 !important" })}"${_scopeId}>`);
        _push2(ssrRenderComponent(_component_l_map, {
          modelValue: $setup.map.zoom,
          "onUpdate:modelValue": ($event) => $setup.map.zoom = $event,
          zoom: $setup.map.zoom,
          "onUpdate:zoom": ($event) => $setup.map.zoom = $event,
          center: [
            $setup.form.latitude,
            $setup.form.longitude
          ],
          onClick: $setup.changeMarker
        }, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(ssrRenderComponent(_component_l_tile_layer, { url: "https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png" }, null, _parent3, _scopeId2));
              _push3(ssrRenderComponent(_component_l_control, { position: "topright" }, {
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`<input type="text" placeholder="Cari..." style="${ssrRenderStyle({ "width": "500px" })}"${_scopeId3}>`);
                    if ($setup.other.searchAddress.length > 0) {
                      _push4(`<div class="collapse show" style="${ssrRenderStyle({ "width": "500px" })}"${_scopeId3}><div class="card card-body rounded-0 border border-dark p-0"${_scopeId3}><!--[-->`);
                      ssrRenderList($setup.other.searchAddress, (addr, i) => {
                        _push4(`<p style="${ssrRenderStyle({ "cursor": "pointer" })}"${_scopeId3}>${ssrInterpolate(addr.label)}</p>`);
                      });
                      _push4(`<!--]-->`);
                      if ($setup.other.searchAddress < 1) {
                        _push4(`<p${_scopeId3}> Alamat tidak ditemukan </p>`);
                      } else {
                        _push4(`<!---->`);
                      }
                      _push4(`</div></div>`);
                    ...
                    return [
                      ...
                      $setup.other.searchAddress.length > 0 ? (openBlock(), createBlock("div", {
                        key: 0,
                        class: "collapse show",
                        style: { "width": "500px" }
                      }, [
                        createVNode("div", { class: "card card-body rounded-0 border border-dark p-0" }, [
                          (openBlock(true), createBlock(Fragment, null, renderList($setup.other.searchAddress, (addr, i) => {
                            return openBlock(), createBlock("p", {
                              style: { "cursor": "pointer" },
                              key: i,
                              onClick: ($event) => $setup.selectAddress(
                                addr.y,
                                addr.x
                              )
                            }, toDisplayString(addr.label), 9, ["onClick"]);
                          }), 128)),
                          $setup.other.searchAddress < 1 ? (openBlock(), createBlock("p", { key: 0 }, " Alamat tidak ditemukan ")) : createCommentVNode("", true)
                        ])
              ...
              _push3(ssrRenderComponent(_component_l_marker, {
                "lat-lng": [
                  $setup.form.latitude,
                  $setup.form.longitude
                ],
                ...
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(ssrRenderComponent(_component_l_tooltip, null, {
                      default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                        if (_push5) {
                          _push5(`${ssrInterpolate(`Lat: ${$setup.form.latitude} Lng: ${$setup.form.longitude}`)}`);
                        } else {
                          return [
                            createTextVNode(toDisplayString(`Lat: ${$setup.form.latitude} Lng: ${$setup.form.longitude}`), 1)
                          ];
                        }
                      }),
                      _: 1
                    ...
                    return [
                      createVNode(_component_l_tooltip, null, {
                        default: withCtx(() => [
                          createTextVNode(toDisplayString(`Lat: ${$setup.form.latitude} Lng: ${$setup.form.longitude}`), 1)
                        ]),
                        _: 1
              ...
              return [
                createVNode(_component_l_tile_layer, { url: "https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png" }),
                createVNode(_component_l_control, { position: "topright" }, {
                  default: withCtx(() => [
                    createVNode("input", {
                      onKeyup: $setup.search,
                      type: "text",
                ...
                createVNode(_component_l_marker, {
                  "lat-lng": [
                    $setup.form.latitude,
                    $setup.form.longitude
                  ],
              ...
              createVNode("div", { class: "card" }, [
                createVNode("div", { class: "card-body" }, [
                  createVNode("form", {
                    ...
                    createVNode("div", { class: "row" }, [
                      createVNode("div", { class: "col-1g-12 mb-3" }, [
                        createVNode("div", { style: { "height": "75vh", "width": "100%", "z-index": "1 !important" } }, [
                          createVNode(_component_l_map, {
                            modelValue: $setup.map.zoom,
                            "onUpdate:modelValue": ($event) => $setup.map.zoom = $event,
                            zoom: $setup.map.zoom,
                            "onUpdate:zoom": ($event) => $setup.map.zoom = $event,
                            ...
                            _: 1
                          }, 8, ["modelValue", "onUpdate:modelValue", "zoom", "onUpdate:zoom", "center", "onClick"])
                        ])
                      ]),
