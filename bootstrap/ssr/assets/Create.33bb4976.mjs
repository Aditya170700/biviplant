...
import { s as slugify } from "./utils.3a466e9c.mjs";
import { C as CurrencyInput } from "./CurrencyInput.30440395.mjs";
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Dashboard/Product/Create.vue");
