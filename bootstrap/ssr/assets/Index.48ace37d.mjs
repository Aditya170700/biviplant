...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_Layout, mergeProps({
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="row"${_scopeId}><div class="col-md-12 grid-margin"${_scopeId}><div class="card"${_scopeId}><div class="card-body"${_scopeId}><div class="d-flex justify-content-start"${_scopeId}><div class="col-lg-2 col-sm-6 me-2"${_scopeId}><div class="mb-3"${_scopeId}><input class="form-control" placeholder="Cari..."${ssrRenderAttr("value", $setup.params.search)}${_scopeId}></div></div><div class="col-lg-2 col-sm-6 me-2"${_scopeId}><select class="form-control mb-3"${_scopeId}><option value="25"${_scopeId}>Lihat 25 data</option><option value="50"${_scopeId}>Lihat 50 data</option><option value="100"${_scopeId}>Lihat 100 data</option><option value="200"${_scopeId}>Lihat 200 data</option></select></div></div><div class="table-responsive"${_scopeId}><table class="table"${_scopeId}><thead class="table-dark"${_scopeId}><tr${_scopeId}><th${_scopeId}>NO</th><th${_scopeId}><span class="d-flex justify-content-between" style="${ssrRenderStyle({ "cursor": "pointer" })}"${_scopeId}> NAMA `);
        if ($setup.params.direction == "asc" && $setup.params.field == "name") {
          _push2(`<i class="fa-solid fa-arrow-down-a-z"${_scopeId}></i>`);
        } else {
          _push2(`<!---->`);
        }
        if ($setup.params.direction == "desc" && $setup.params.field == "name") {
          _push2(`<i class="fa-solid fa-arrow-up-z-a"${_scopeId}></i>`);
        } else {
          _push2(`<!---->`);
        }
        _push2(`</span></th><th${_scopeId}><span class="d-flex justify-content-between" style="${ssrRenderStyle({ "cursor": "pointer" })}"${_scopeId}> HARGA `);
        if ($setup.params.direction == "asc" && $setup.params.field == "price") {
          _push2(`<i class="fa-solid fa-arrow-down-a-z"${_scopeId}></i>`);
        } else {
          _push2(`<!---->`);
        }
        if ($setup.params.direction == "desc" && $setup.params.field == "price") {
          _push2(`<i class="fa-solid fa-arrow-up-z-a"${_scopeId}></i>`);
        } else {
          _push2(`<!---->`);
        }
        _push2(`</span></th><th${_scopeId}><span class="d-flex justify-content-between" style="${ssrRenderStyle({ "cursor": "pointer" })}"${_scopeId}> HARGA CORET `);
        if ($setup.params.direction == "asc" && $setup.params.field == "strike_price") {
          _push2(`<i class="fa-solid fa-arrow-down-a-z"${_scopeId}></i>`);
        } else {
          _push2(`<!---->`);
        }
        if ($setup.params.direction == "desc" && $setup.params.field == "strike_price") {
          _push2(`<i class="fa-solid fa-arrow-up-z-a"${_scopeId}></i>`);
        } else {
          _push2(`<!---->`);
        }
        _push2(`</span></th><th${_scopeId}><span class="d-flex justify-content-between" style="${ssrRenderStyle({ "cursor": "pointer" })}"${_scopeId}> BERAT `);
        if ($setup.params.direction == "asc" && $setup.params.field == "weight") {
          _push2(`<i class="fa-solid fa-arrow-down-a-z"${_scopeId}></i>`);
        } else {
          _push2(`<!---->`);
        }
        if ($setup.params.direction == "desc" && $setup.params.field == "weight") {
          _push2(`<i class="fa-solid fa-arrow-up-z-a"${_scopeId}></i>`);
        } else {
          _push2(`<!---->`);
        }
        _push2(`</span></th><th${_scopeId}><span class="d-flex justify-content-between" style="${ssrRenderStyle({ "cursor": "pointer" })}"${_scopeId}> STOK `);
        if ($setup.params.direction == "asc" && $setup.params.field == "stock") {
          _push2(`<i class="fa-solid fa-arrow-down-a-z"${_scopeId}></i>`);
        } else {
          _push2(`<!---->`);
        }
        if ($setup.params.direction == "desc" && $setup.params.field == "stock") {
          _push2(`<i class="fa-solid fa-arrow-up-z-a"${_scopeId}></i>`);
        } else {
          _push2(`<!---->`);
        }
        ...
        ssrRenderList($props.results.data, (result, i) => {
          _push2(`<tr${_scopeId}><td${_scopeId}>${ssrInterpolate(i + 1)}</td><td${_scopeId}>${ssrInterpolate(result.name)}</td><td${_scopeId}>${ssrInterpolate(result.price_rp)}</td><td${_scopeId}>${ssrInterpolate(result.strike_price_rp)}</td><td${_scopeId}>${ssrInterpolate(result.weight)}gr</td><td${_scopeId}>${ssrInterpolate(result.stock)}</td><td class="d-flex justify-content-end"${_scopeId}>`);
          _push2(ssrRenderComponent(_component_Link, {
            ...
            default: withCtx((_2, _push3, _parent3, _scopeId2) => {
              if (_push3) {
                _push3(`<i class="fas fa-location-arrow"${_scopeId2}></i>`);
              } else {
                return [
          ...
          _push2(ssrRenderComponent(_component_Link, {
            ...
            default: withCtx((_2, _push3, _parent3, _scopeId2) => {
              if (_push3) {
                _push3(`<i class="fas fa-images"${_scopeId2}></i>`);
              } else {
                return [
                  createVNode("i", { class: "fas fa-images" })
                ];
              }
            }),
            _: 2
        ...
        _push2(`</div></div></div></div></div><div class="modal fade" id="attachSuplier" tabindex="-1" aria-labelledby="attachSuplierLabel" aria-hidden="true"${_scopeId}><div class="modal-dialog modal-lg"${_scopeId}><div class="modal-content rounded-custom"${_scopeId}><div class="modal-body"${_scopeId}><div class="d-flex justify-content-between align-items-center mb-3"${_scopeId}><div class="h5"${_scopeId}>Pilih Suplier</div></div><div class="row"${_scopeId}></div></div></div></div></div>`);
      } else {
        return [
                    ...
                    createVNode("table", { class: "table" }, [
                      createVNode("thead", { class: "table-dark" }, [
                        createVNode("tr", null, [
                          ...
                          createVNode("th", null, [
                            createVNode("span", {
                              onClick: ($event) => $setup.sort("name"),
                              class: "d-flex justify-content-between",
                              style: { "cursor": "pointer" }
                            }, [
                              createTextVNode(" NAMA "),
                              $setup.params.direction == "asc" && $setup.params.field == "name" ? (openBlock(), createBlock("i", {
                                key: 0,
                                class: "fa-solid fa-arrow-down-a-z"
                              })) : createCommentVNode("", true),
                              $setup.params.direction == "desc" && $setup.params.field == "name" ? (openBlock(), createBlock("i", {
                                key: 1,
                          ...
                          createVNode("th", null, [
                            createVNode("span", {
                              onClick: ($event) => $setup.sort("price"),
                              class: "d-flex justify-content-between",
                              style: { "cursor": "pointer" }
                            }, [
                              createTextVNode(" HARGA "),
                              $setup.params.direction == "asc" && $setup.params.field == "price" ? (openBlock(), createBlock("i", {
                                key: 0,
                                class: "fa-solid fa-arrow-down-a-z"
                              })) : createCommentVNode("", true),
                              $setup.params.direction == "desc" && $setup.params.field == "price" ? (openBlock(), createBlock("i", {
                                key: 1,
                                class: "fa-solid fa-arrow-up-z-a"
                              })) : createCommentVNode("", true)
                            ], 8, ["onClick"])
                          ...
                          createVNode("th", null, [
                            createVNode("span", {
                              onClick: ($event) => $setup.sort("strike_price"),
                              class: "d-flex justify-content-between",
                              style: { "cursor": "pointer" }
                            }, [
                              createTextVNode(" HARGA CORET "),
                              $setup.params.direction == "asc" && $setup.params.field == "strike_price" ? (openBlock(), createBlock("i", {
                                key: 0,
                                class: "fa-solid fa-arrow-down-a-z"
                              })) : createCommentVNode("", true),
                              $setup.params.direction == "desc" && $setup.params.field == "strike_price" ? (openBlock(), createBlock("i", {
                                key: 1,
                                class: "fa-solid fa-arrow-up-z-a"
                              })) : createCommentVNode("", true)
                            ], 8, ["onClick"])
                          ...
                          createVNode("th", null, [
                            createVNode("span", {
                              onClick: ($event) => $setup.sort("weight"),
                              class: "d-flex justify-content-between",
                              style: { "cursor": "pointer" }
                            }, [
                              createTextVNode(" BERAT "),
                              $setup.params.direction == "asc" && $setup.params.field == "weight" ? (openBlock(), createBlock("i", {
                                key: 0,
                                class: "fa-solid fa-arrow-down-a-z"
                              })) : createCommentVNode("", true),
                              $setup.params.direction == "desc" && $setup.params.field == "weight" ? (openBlock(), createBlock("i", {
                                key: 1,
                                class: "fa-solid fa-arrow-up-z-a"
                              })) : createCommentVNode("", true)
                            ], 8, ["onClick"])
                          ...
                          createVNode("th", null, [
                            createVNode("span", {
                              onClick: ($event) => $setup.sort("stock"),
                              class: "d-flex justify-content-between",
                              style: { "cursor": "pointer" }
                            }, [
                              createTextVNode(" STOK "),
                              $setup.params.direction == "asc" && $setup.params.field == "stock" ? (openBlock(), createBlock("i", {
                                key: 0,
                                class: "fa-solid fa-arrow-down-a-z"
                              })) : createCommentVNode("", true),
                              $setup.params.direction == "desc" && $setup.params.field == "stock" ? (openBlock(), createBlock("i", {
                                key: 1,
                                class: "fa-solid fa-arrow-up-z-a"
                              })) : createCommentVNode("", true)
                            ], 8, ["onClick"])
                      ...
                      createVNode("tbody", null, [
                        (openBlock(true), createBlock(Fragment, null, renderList($props.results.data, (result, i) => {
                          return openBlock(), createBlock("tr", { key: i }, [
                            ...
                            createVNode("td", null, toDisplayString(result.name), 1),
                            createVNode("td", null, toDisplayString(result.price_rp), 1),
                            createVNode("td", null, toDisplayString(result.strike_price_rp), 1),
                            createVNode("td", null, toDisplayString(result.weight) + "gr", 1),
                            createVNode("td", null, toDisplayString(result.stock), 1),
              ...
              createVNode("div", { class: "modal-content rounded-custom" }, [
                createVNode("div", { class: "modal-body" }, [
                  createVNode("div", { class: "d-flex justify-content-between align-items-center mb-3" }, [
                    createVNode("div", { class: "h5" }, "Pilih Suplier")
                  ]),
                  createVNode("div", { class: "row" })
                ])
              ])
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Dashboard/Product/Index.vue");
