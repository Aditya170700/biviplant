  ...
  _push(ssrRenderComponent(_component_Layout, mergeProps({
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        if ($setup.form.errors.link) {
          _push2(ssrRenderComponent(_component_FormText, {
            id: "link",
            message: $setup.form.errors.link
          }, null, _parent2, _scopeId));
        } else {
          _push2(`<!---->`);
        }
                    ...
                    createVNode("div", { class: "row" }, [
                      ...
                      createVNode("div", { class: "col-lg-6 mb-3" }, [
                        createVNode("div", { class: "mb-3" }, [
                          ...
                          $setup.form.errors.link ? (openBlock(), createBlock(_component_FormText, {
                            key: 0,
                            id: "link",
                            message: $setup.form.errors.link
                          }, null, 8, ["message"])) : createCommentVNode("", true)
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Dashboard/Banner/Create.vue");
