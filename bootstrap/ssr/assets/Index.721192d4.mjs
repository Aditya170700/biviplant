  ...
  _push(ssrRenderComponent(_component_Layout, mergeProps({
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(`</span></th><th${_scopeId}><span class="d-flex justify-content-between" style="${ssrRenderStyle({ "cursor": "pointer" })}"${_scopeId}> ROLE `);
        if ($setup.params.direction == "asc" && $setup.params.field == "role") {
          _push2(`<i class="fa-solid fa-arrow-down-a-z"${_scopeId}></i>`);
        } else {
          _push2(`<!---->`);
        }
        if ($setup.params.direction == "desc" && $setup.params.field == "role") {
          _push2(`<i class="fa-solid fa-arrow-up-z-a"${_scopeId}></i>`);
        } else {
          _push2(`<!---->`);
        }
        _push2(`</span></th><th${_scopeId}><span class="d-flex justify-content-between" style="${ssrRenderStyle({ "cursor": "pointer" })}"${_scopeId}> EMAIL `);
        if ($setup.params.direction == "asc" && $setup.params.field == "email") {
          _push2(`<i class="fa-solid fa-arrow-down-a-z"${_scopeId}></i>`);
        } else {
          _push2(`<!---->`);
        }
        if ($setup.params.direction == "desc" && $setup.params.field == "email") {
          _push2(`<i class="fa-solid fa-arrow-up-z-a"${_scopeId}></i>`);
        } else {
          _push2(`<!---->`);
        }
        _push2(`</span></th><th${_scopeId}><span class="d-flex justify-content-between" style="${ssrRenderStyle({ "cursor": "pointer" })}"${_scopeId}> TELEPON `);
        if ($setup.params.direction == "asc" && $setup.params.field == "phone") {
          _push2(`<i class="fa-solid fa-arrow-down-a-z"${_scopeId}></i>`);
        } else {
          _push2(`<!---->`);
        }
        if ($setup.params.direction == "desc" && $setup.params.field == "phone") {
          _push2(`<i class="fa-solid fa-arrow-up-z-a"${_scopeId}></i>`);
        } else {
          _push2(`<!---->`);
        }
        ...
        ssrRenderList($props.results.data, (result, i) => {
          _push2(`<tr${_scopeId}><td${_scopeId}>${ssrInterpolate(i + 1)}</td><td${_scopeId}>${ssrInterpolate(result.name)}</td><td${_scopeId}>${ssrInterpolate(result.role)}</td><td${_scopeId}>${ssrInterpolate(result.email)}</td><td${_scopeId}>${ssrInterpolate(result.phone)}</td><td class="d-flex justify-content-end"${_scopeId}>`);
          _push2(ssrRenderComponent(_component_Link, {
            href: _ctx.route("admin.users.show", {
              id: result.id
            }),
                    ...
                    createVNode("table", { class: "table" }, [
                      createVNode("thead", { class: "table-dark" }, [
                        createVNode("tr", null, [
                          ...
                          createVNode("th", null, [
                            createVNode("span", {
                              onClick: ($event) => $setup.sort("role"),
                              class: "d-flex justify-content-between",
                              style: { "cursor": "pointer" }
                            }, [
                              createTextVNode(" ROLE "),
                              $setup.params.direction == "asc" && $setup.params.field == "role" ? (openBlock(), createBlock("i", {
                                key: 0,
                                class: "fa-solid fa-arrow-down-a-z"
                              })) : createCommentVNode("", true),
                              $setup.params.direction == "desc" && $setup.params.field == "role" ? (openBlock(), createBlock("i", {
                                key: 1,
                                class: "fa-solid fa-arrow-up-z-a"
                              })) : createCommentVNode("", true)
                            ], 8, ["onClick"])
                          ...
                          createVNode("th", null, [
                            createVNode("span", {
                              onClick: ($event) => $setup.sort("email"),
                              class: "d-flex justify-content-between",
                              style: { "cursor": "pointer" }
                            }, [
                              createTextVNode(" EMAIL "),
                              $setup.params.direction == "asc" && $setup.params.field == "email" ? (openBlock(), createBlock("i", {
                                key: 0,
                                class: "fa-solid fa-arrow-down-a-z"
                              })) : createCommentVNode("", true),
                              $setup.params.direction == "desc" && $setup.params.field == "email" ? (openBlock(), createBlock("i", {
                                key: 1,
                                class: "fa-solid fa-arrow-up-z-a"
                              })) : createCommentVNode("", true)
                            ], 8, ["onClick"])
                          ...
                          createVNode("th", null, [
                            createVNode("span", {
                              onClick: ($event) => $setup.sort("phone"),
                              class: "d-flex justify-content-between",
                              style: { "cursor": "pointer" }
                            }, [
                              createTextVNode(" TELEPON "),
                              $setup.params.direction == "asc" && $setup.params.field == "phone" ? (openBlock(), createBlock("i", {
                                key: 0,
                                class: "fa-solid fa-arrow-down-a-z"
                              })) : createCommentVNode("", true),
                              $setup.params.direction == "desc" && $setup.params.field == "phone" ? (openBlock(), createBlock("i", {
                                key: 1,
                                class: "fa-solid fa-arrow-up-z-a"
                              })) : createCommentVNode("", true)
                            ], 8, ["onClick"])
                      ...
                      createVNode("tbody", null, [
                        (openBlock(true), createBlock(Fragment, null, renderList($props.results.data, (result, i) => {
                          return openBlock(), createBlock("tr", { key: i }, [
                            ...
                            createVNode("td", null, toDisplayString(result.role), 1),
                            createVNode("td", null, toDisplayString(result.email), 1),
