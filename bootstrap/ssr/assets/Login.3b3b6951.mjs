...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<p class="mb-0 text-dark"> Didn&#39;t have an account?`);
      _push(ssrRenderComponent(unref(Link), {
      ...
      _push(`</p></div><div class="view-as-guest mt-3">`);
      _push(ssrRenderComponent(unref(Link), {
        class: "btn",
        href: "/"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`View as Guest`);
          } else {
            return [
              createTextVNode("View as Guest")
            ];
          }
        }),
        _: 1
