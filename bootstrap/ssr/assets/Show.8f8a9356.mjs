            ...
            createVNode("div", { class: "col-md-12 grid-margin" }, [
              createVNode("div", { class: "card" }, [
                createVNode("div", { class: "card-body" }, [
                  ...
                  createVNode("div", { class: "row mt-3" }, [
                    createVNode("div", { class: "col-lg-2" }, "Link"),
                    createVNode("div", { class: "col-lg-10" }, ": " + toDisplayString($props.result.link), 1)
                  ]),
                  createVNode("div", { class: "row mt-3" }, [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Dashboard/Banner/Show.vue");
