...
import { S as SpinnerProcessing } from "./SpinnerProcessing.6b8068f7.mjs";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(unref(LTooltip), null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`${ssrInterpolate(`Lat: ${form.latitude} Lng: ${form.longitude}`)}`);
                      } else {
                        return [
                          createTextVNode(toDisplayString(`Lat: ${form.latitude} Lng: ${form.longitude}`), 1)
                        ];
                      }
                    }),
                    _: 1
      ...
      _push(`</div></div><div class="col-6 mb-3"><div class="mb-3"><label for="longitude" class="form-label">Longitude</label><input class="form-control" id="longitude"${ssrRenderAttr("value", form.longitude)} disabled></div></div><div class="col-6 mb-3"><div class="mb-3"><label for="latitude" class="form-label">Latitude</label><input class="form-control" id="latitude"${ssrRenderAttr("value", form.latitude)} disabled></div></div><div class="col-6 mb-3"><div class="mb-3"><label for="receiver" class="form-label">Nama Penerima</label><input class="form-control" id="receiver"${ssrRenderAttr("value", form.receiver)}></div></div><div class="col-6 mb-3"><div class="mb-3"><label for="phone" class="form-label">No HP</label><input class="form-control" id="sender"${ssrRenderAttr("value", form.phone)}></div></div><div class="col-12 mb-3"><label for="province_id" class="form-label">Provinsi</label><select class="form-control mb-3" id="province_id"><!--[-->`);
      ...
      _push(`<!--]--></select></div><div class="col-12 mb-3"><div class="mb-3"><label for="postal_code" class="form-label">Kode Pos</label><input class="form-control" id="postal_code"${ssrRenderAttr("value", form.postal_code)}></div></div><div class="col-12 mb-3"><div class="mb-3"><label for="detail" class="form-label">Alamat Detail</label><textarea class="form-control" id="detail" rows="3">${ssrInterpolate(form.detail)}</textarea></div></div><div class="col-6"><div class="d-grid"><button class="btn btn-success rounded-custom"${ssrIncludeBooleanAttr(form.processing) ? " disabled" : ""}><div class="d-flex justify-content-center align-items-center">`);
      if (form.processing) {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/AddressGuest/Create.vue");
