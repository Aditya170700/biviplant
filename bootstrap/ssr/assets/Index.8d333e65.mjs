  ...
  setup(props) {
    ...
    let destroy = (id) => {
      confirmation(
        ...
        if (res) {
          Inertia.delete(route("admin.events.destroy", { id }));
        }
      });
    };
    return {
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_Layout, mergeProps({
    title: "Event",
    typeButton: "create",
    href: _ctx.route("admin.events.create")
  }, _attrs), {
      ...
      if (_push2) {
        ...
        ssrRenderList($props.results.data, (result, i) => {
          ...
          _push2(ssrRenderComponent(_component_Link, {
            href: _ctx.route("admin.events.show", {
              id: result.id
            }),
          ...
          _push2(ssrRenderComponent(_component_Link, {
            href: _ctx.route("admin.events.edit", {
              id: result.id
            }),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Dashboard/Event/Index.vue");
