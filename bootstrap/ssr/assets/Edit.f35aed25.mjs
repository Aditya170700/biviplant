...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const form = useForm({
      id: (_a = attrs.result.id) != null ? _a : "",
      province_id: (_b = attrs.result.subdistrict.city.province_id) != null ? _b : "",
      city_id: (_c = attrs.result.subdistrict.city_id) != null ? _c : "",
      user_id: (_d = attrs.result.user_id) != null ? _d : "",
      subdistrict_id: (_e = attrs.result.subdistrict_id) != null ? _e : "",
      longitude: (_f = parseFloat(attrs.result.longitude)) != null ? _f : 0,
      latitude: (_g = parseFloat(attrs.result.latitude)) != null ? _g : 0,
      receiver: (_h = attrs.result.receiver) != null ? _h : "",
      phone: (_i = attrs.result.phone) != null ? _i : "",
      postal_code: (_j = attrs.result.postal_code) != null ? _j : "",
      detail: (_k = attrs.result.detail) != null ? _k : ""
    });
    let other = reactive({
      provinces: [],
      cities: [],
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Address/Edit.vue");
