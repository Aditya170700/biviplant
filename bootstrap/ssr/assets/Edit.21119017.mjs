  ...
  _push(ssrRenderComponent(_component_Layout, mergeProps({
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(`</div></div><div class="col-lg-6 mb-3"${_scopeId}><div class="mb-3"${_scopeId}><label for="link" class="form-label"${_scopeId}>Link</label><textarea class="form-control" id="link" rows="3"${_scopeId}>${ssrInterpolate($setup.form.link)}</textarea>`);
        if ($props.errors.link) {
          _push2(ssrRenderComponent(_component_FormText, {
            id: "link",
            message: $props.errors.link
          }, null, _parent2, _scopeId));
        } else {
          _push2(`<!---->`);
        }
        ...
        if ($props.errors.path) {
          _push2(ssrRenderComponent(_component_FormText, {
            id: "banner",
            message: $props.errors.path
          }, null, _parent2, _scopeId));
        } else {
          _push2(`<!---->`);
        }
                    ...
                    createVNode("div", { class: "row" }, [
                      ...
                      createVNode("div", { class: "col-lg-6 mb-3" }, [
                        createVNode("div", { class: "mb-3" }, [
                          ...
                          withDirectives(createVNode("textarea", {
                            ...
                            id: "link",
                            rows: "3",
                            "onUpdate:modelValue": ($event) => $setup.form.link = $event
                          }, null, 8, ["onUpdate:modelValue"]), [
                            [vModelText, $setup.form.link]
                          ]),
                          $props.errors.link ? (openBlock(), createBlock(_component_FormText, {
                            key: 0,
                            id: "link",
                            message: $props.errors.link
                          }, null, 8, ["message"])) : createCommentVNode("", true)
                      ...
                      createVNode("div", { class: "col-lg-6 mb-3" }, [
                        createVNode("div", { class: "mb-3" }, [
                          ...
                          $props.errors.path ? (openBlock(), createBlock(_component_FormText, {
                            key: 0,
                            id: "banner",
                            message: $props.errors.path
                          }, null, 8, ["message"])) : createCommentVNode("", true)
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Dashboard/Banner/Edit.vue");
