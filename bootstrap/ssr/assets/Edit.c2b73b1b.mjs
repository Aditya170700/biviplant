...
import { i as imageReader, d as dataURLtoFile, s as slugify } from "./utils.bec59827.mjs";
  ...
  _push(ssrRenderComponent(_component_Layout, mergeProps({
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        if ($props.errors.meta_title) {
          _push2(ssrRenderComponent(_component_FormText, {
            id: "meta_title",
            message: $props.errors.meta_title
          }, null, _parent2, _scopeId));
        } else {
          _push2(`<!---->`);
        }
        ...
        if ($props.errors.meta_description) {
          _push2(ssrRenderComponent(_component_FormText, {
            id: "meta_description",
            message: $props.errors.meta_description
          }, null, _parent2, _scopeId));
        } else {
          _push2(`<!---->`);
        }
        ...
        if ($props.errors.meta_keyword) {
          _push2(ssrRenderComponent(_component_FormText, {
            id: "meta_keyword",
            message: $props.errors.meta_keyword
          }, null, _parent2, _scopeId));
        } else {
          _push2(`<!---->`);
        }
                    ...
                    createVNode("div", { class: "row" }, [
                      ...
                      createVNode("div", { class: "col-lg-6 mb-3" }, [
                        createVNode("div", { class: "mb-3" }, [
                          ...
                          $props.errors.meta_title ? (openBlock(), createBlock(_component_FormText, {
                            key: 0,
                            id: "meta_title",
                            message: $props.errors.meta_title
                          }, null, 8, ["message"])) : createCommentVNode("", true)
                      ...
                      createVNode("div", { class: "col-lg-6 mb-3" }, [
                        createVNode("div", { class: "mb-3" }, [
                          ...
                          $props.errors.meta_description ? (openBlock(), createBlock(_component_FormText, {
                            key: 0,
                            id: "meta_description",
                            message: $props.errors.meta_description
                          }, null, 8, ["message"])) : createCommentVNode("", true)
                      ...
                      createVNode("div", { class: "col-lg-6 mb-3" }, [
                        createVNode("div", { class: "mb-3" }, [
                          ...
                          $props.errors.meta_keyword ? (openBlock(), createBlock(_component_FormText, {
                            key: 0,
                            id: "meta_keyword",
                            message: $props.errors.meta_keyword
                          }, null, 8, ["message"])) : createCommentVNode("", true)
