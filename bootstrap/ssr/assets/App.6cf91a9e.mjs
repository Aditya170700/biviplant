...
const Sidebar_vue_vue_type_style_index_0_scoped_87923e52_lang = "";
const _sfc_main$2 = {
  components: {
    Link
  },
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({
    id: "sidebar",
    class: $props.sidebar
  }, _attrs))} data-v-87923e52><div class="sidebar-wrapper active" style="${ssrRenderStyle({ "z-index": "99999 !important" })}" data-v-87923e52><div class="sidebar-header position-relative" data-v-87923e52><div class="d-flex justify-content-between align-items-center" data-v-87923e52><div class="logo" data-v-87923e52><a href="index.html" data-v-87923e52><img src="/assets/images/logo/logo.svg" alt="Logo" srcset="" data-v-87923e52></a></div><div class="theme-toggle d-flex gap-2 align-items-center mt-2" data-v-87923e52><i class="fas fa-sun me-2" style="${ssrRenderStyle({ "font-size": "20px !important" })}" data-v-87923e52></i><div class="form-check form-switch fs-6" data-v-87923e52><input class="form-check-input me-0" type="checkbox" id="toggle-dark" data-v-87923e52><label class="form-check-label" data-v-87923e52></label></div><i class="fas fa-moon" style="${ssrRenderStyle({ "font-size": "20px !important" })}" data-v-87923e52></i></div><div class="sidebar-toggler x" data-v-87923e52><a href="#" class="sidebar-hide d-xl-none d-block" data-v-87923e52><i class="fas fa-xmark" data-v-87923e52></i></a></div></div></div><div class="sidebar-menu" data-v-87923e52><ul class="menu" data-v-87923e52><li class="${ssrRenderClass([
    "sidebar-item",
  ...
  _push(ssrRenderComponent(_component_Link, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<i class="fas fa-dashboard" data-v-87923e52${_scopeId}></i><span data-v-87923e52${_scopeId}>Dashboard</span>`);
      } else {
        return [
  ...
  _push(`</li><li class="${ssrRenderClass([
    "sidebar-item",
    _ctx.route().current().includes("admin.chat") ? "active" : ""
  ])}" data-v-87923e52>`);
  _push(ssrRenderComponent(_component_Link, {
    href: _ctx.route("admin.chat.index"),
    class: "sidebar-link"
  }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<i class="fa fa-paper-plane" data-v-87923e52${_scopeId}></i><span data-v-87923e52${_scopeId}>Chat</span>`);
      } else {
        return [
          createVNode("i", { class: "fa fa-paper-plane" }),
          createVNode("span", null, "Chat")
        ];
      }
    }),
    _: 1
  ...
  _push(`</li><li class="${ssrRenderClass([
    "sidebar-item",
    "has-sub",
    _ctx.route().current().includes("admin.categories") || _ctx.route().current().includes("admin.banners") || _ctx.route().current().includes("admin.users") || _ctx.route().current().includes("admin.events") || _ctx.route().current().includes("admin.origins") || _ctx.route().current().includes("admin.vouchers") ? "active" : ""
  ])}" data-v-87923e52><a href="#" class="sidebar-link" data-v-87923e52><i class="fas fa-book" data-v-87923e52></i><span data-v-87923e52>Data Master</span></a><ul class="${ssrRenderClass([
    "submenu",
    "has-sub",
    _ctx.route().current().includes("admin") ? "active" : ""
  ])}" data-v-87923e52><li class="${ssrRenderClass([
    "submenu-item",
  ...
  _push(ssrRenderComponent(_component_Link, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<i class="fas fa-o" data-v-87923e52${_scopeId}></i><span data-v-87923e52${_scopeId}>Kategori</span>`);
      } else {
        return [
  ...
  _push(ssrRenderComponent(_component_Link, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<i class="fas fa-o" data-v-87923e52${_scopeId}></i><span data-v-87923e52${_scopeId}>Banner</span>`);
      } else {
        return [
          createVNode("i", { class: "fas fa-o" }),
  ...
  _push(ssrRenderComponent(_component_Link, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<i class="fas fa-o" data-v-87923e52${_scopeId}></i><span data-v-87923e52${_scopeId}>Pengguna</span>`);
      } else {
        return [
          createVNode("i", { class: "fas fa-o" }),
  ...
  _push(ssrRenderComponent(_component_Link, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<i class="fas fa-o" data-v-87923e52${_scopeId}></i><span data-v-87923e52${_scopeId}>Event</span>`);
      } else {
        return [
          createVNode("i", { class: "fas fa-o" }),
  ...
  _push(ssrRenderComponent(_component_Link, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<i class="fas fa-o" data-v-87923e52${_scopeId}></i><span data-v-87923e52${_scopeId}>Voucher</span>`);
      } else {
        return [
          createVNode("i", { class: "fas fa-o" }),
  ...
  _push(ssrRenderComponent(_component_Link, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<i class="fas fa-o" data-v-87923e52${_scopeId}></i><span data-v-87923e52${_scopeId}>Suplier</span>`);
      } else {
        return [
          createVNode("i", { class: "fas fa-o" }),
  ...
  _push(ssrRenderComponent(_component_Link, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<i class="fas fa-cubes" data-v-87923e52${_scopeId}></i><span data-v-87923e52${_scopeId}>Produk</span>`);
      } else {
        return [
  ...
  _push(ssrRenderComponent(_component_Link, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<i class="fas fa-cart-shopping" data-v-87923e52${_scopeId}></i><span data-v-87923e52${_scopeId}>Pesanan</span>`);
      } else {
        return [
  ...
  _push(`</li><li class="sidebar-title" data-v-87923e52>Lainnya</li><li class="${ssrRenderClass([
    "sidebar-item",
  ...
  _push(ssrRenderComponent(_component_Link, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<i class="fas fa-cog" data-v-87923e52${_scopeId}></i><span data-v-87923e52${_scopeId}>Pengaturan</span>`);
      } else {
        return [
  ...
  _push(`</li><li class="sidebar-item" data-v-87923e52><a href="#" class="sidebar-link" data-v-87923e52><i class="fas fa-power-off" data-v-87923e52></i><span data-v-87923e52>Keluar</span></a></li></ul></div></div></div>`);
}
...
const Sidebar = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$2], ["__scopeId", "data-v-87923e52"]]);
const _sfc_main$1 = {};
