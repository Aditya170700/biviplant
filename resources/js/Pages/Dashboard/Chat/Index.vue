...
socket.on("message", (data) => {
    ...
    if (activeUser.value?.id && activeUser.value?.id == data.user.id) {
        ...
        nextTick(() => {
            window.document
                .getElementsByClassName("chat-room")[0]
                .scrollTo(
                    0,
                    window.document.getElementsByClassName("chat-room")[0]
                        .scrollHeight
                );
        });
    }
...
function submit() {
    if (textMessage.value != "") {
        let toUser =
            conversation.data.sender.id != props.user.id
...
function getCustomers() {
    axios
        .get(route("admin.chat.customers"))
        .then((res) => {
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            >
                                <div class="p-3">
                                    <div
                                        class="input-group rounded mb-3 shadow-sm"
                                    >
                                        <input
                                            type="search"
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <div>
                                                            <img
                                                                :src="
                                                                    customer.profile_photo_path_url
                                                                "
                                                                alt="avatar"
                            ...
                            <div class="col-md-6 col-lg-7 col-xl-8">
                                ...
                                >
                                    <div class="d-flex flex-row">
                                        <div>
                                            <img
                                                :src="
                                                    activeUser.profile_photo_path_url
                                                "
                                                alt="avatar"
                                                class="d-flex align-self-center me-3"
                                                width="50"
                                ...
                                >
                                    ...
                                    ></a>
                                    <a class="ms-3" href="#!" @click="submit()"
