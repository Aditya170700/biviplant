                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="table-responsive">
                                    ...
                                    <Pagination
                                        class="mt-2"
                                        :links="result.origins.links"
                                        :from="result.origins.from"
                                        :to="result.origins.to"
                                        :total="result.origins.total"
                                    />
                                </div>
                            </div>
                        </div>
...
export default {
    ...
    setup(props) {
        ...
        function submit() {
            form.transform((data) => ({
                ...data,
            })).post(route("admin.products.origins.store", props.result.id), {
                onSuccess: () => {
                    form.reset(
                        "province_id",
                        "city_id",
        ...
        let destroy = (id) => {
            confirmation(
                ...
                if (res) {
                    Inertia.delete(
                        route("admin.products.origins.destroy", {
                            id: props.result.id,
                            originId: id,
                        })
                    );
