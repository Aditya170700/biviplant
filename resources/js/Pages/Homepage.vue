            ...
            <div class="flash-sale-wrapper">
                <div class="container">
                    ...
                    <div class="flash-sale-slide owl-carousel">
                        <div class="card flash-sale-card shadow-sm">
                            <div class="card-body">
                                <a href="single-product.html"
                                    ><img
                                        src="/img/product/1.png"
                                        alt="" /><span class="product-title"
                                        >Black Table Lamp</span
                                    >
                                    <p class="sale-price">
                        ...
                        <div class="card flash-sale-card shadow-sm">
                            <div class="card-body">
                                <a href="single-product.html"
                                    ><img src="img/product/2.png" alt="" /><span
                                        class="product-title"
                                        >Modern Sofa</span
                                    >
                                    <p class="sale-price">
                        ...
                        <div class="card flash-sale-card shadow-sm">
                            <div class="card-body">
                                <a href="single-product.html"
                                    ><img src="img/product/3.png" alt="" /><span
                                        class="product-title"
                                        >Classic Garden Chair</span
                                    >
                                    <p class="sale-price">
                        ...
                        <div class="card flash-sale-card shadow-sm">
                            <div class="card-body">
                                <a href="single-product.html"
                                    ><img src="img/product/1.png" alt="" /><span
                                        class="product-title"
                                        >Black Table Lamp</span
                                    >
                                    <p class="sale-price">
            ...
            <div class="cta-area">
                <div class="container">
                    ...
                    >
                        ...
                        <p class="text-white">
                            Suha is a multipurpose, creative &amp; <br />modern
                            mobile template.
                        </p>
                        <a class="btn btn-warning" href="#">Shop Today</a>
                    </div>
                </div>
            </div>
            <div class="weekly-best-seller-area py-3">
                <div class="container">
                    ...
                    >
                        ...
                        <a class="btn" href="shop-list.html">View All</a>
                    </div>
                    <div class="row g-3">
